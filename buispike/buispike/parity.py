...
_TF_SIZES = {
    "1": ("--space-5", "max(var(--radius-2),var(--radius-full))", "1", "calc(var(--space-1)*1.5-var(--tf-bw))"),
    "2": ("--space-6", "max(var(--radius-2),var(--radius-full))", "2", "calc(var(--space-2)-var(--tf-bw))"),
    "3": ("--space-7", "max(var(--radius-3),var(--radius-full))", "3", "calc(var(--space-3)-var(--tf-bw))"),
}
_TF_VARIANTS = {
    "surface": ("1px", "bg-[var(--color-surface)]", "text-[var(--gray-12)]", "shadow-[inset_0_0_0_1px_var(--gray-a7)]"),
    "soft": ("0px", "bg-[var(--accent-a3)]", "text-[var(--accent-12)]", ""),
}


def text_field(*children, size: str = "2", variant: str = "surface", **props) -> rx.Component:
...
_TA_SIZES = {"1": ("var(--space-8)", "2"), "2": ("var(--space-9)", "2"), "3": ("80px", "3")}
_TA_VARIANTS = {
    "surface": ("1px", "bg-[var(--color-surface)]", "text-[var(--gray-12)]", "shadow-[inset_0_0_0_1px_var(--gray-a7)]"),
    "soft": ("0px", "bg-[var(--accent-a3)]", "text-[var(--accent-12)]", ""),
}
...
def text_area(*children, size: str = "2", variant: str = "surface", **props) -> rx.Component:
...
from buispike.parity_ext import *  # noqa: E402,F401,F403
